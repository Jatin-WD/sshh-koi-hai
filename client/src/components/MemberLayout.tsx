...
const nav = [["/app/discover", "Discover", "Home"], ["/app/likes", "Likes", "Like"], ["/app/matches", "Matches", "Match"], ["/app/messages", "Chat", "Chat"]];
