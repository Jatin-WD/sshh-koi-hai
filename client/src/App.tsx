...
import { About, Contact, HowItWorks, Privacy, Terms } from "./pages/PublicPages";
...
export default function App() {
  return <div className="min-h-screen bg-cream text-charcoal"><Seo /><Routes>
    ...
    <Route element={<ProtectedRoute />}><Route element={<MemberLayout />}><Route element={<SettingsLayout />}><Route path="/settings/account" element={<AccountSettings />} /><Route path="/settings/privacy" element={<PrivacySettingsPage />} /><Route path="/settings/notifications" element={<Notifications />} /><Route path="/settings/security" element={<SecuritySettings />} /><Route path="/settings/membership" element={<MembershipSettings />} /></Route><Route path="/notifications" element={<Notifications />} /><Route path="/account" element={<Account />} /><Route path="/profile" element={<ProfilePage />} /><Route path="/app" element={<Navigate to="/app/discover" replace />} /><Route path="/app/profile" element={<ProfilePage />} /><Route path="/app/notifications" element={<Notifications />} /></Route></Route>
    <Route element={<ProtectedRoute />}><Route element={<MemberLayout />}><Route element={<SubscriptionGuard />}><Route path="/app/discover" element={<Discover />} /><Route path="/app/likes" element={<Likes />} /><Route path="/app/matches" element={<Matches />} /><Route path="/app/messages" element={<Messages />} /><Route path="/app/messages/:conversationId" element={<Messages />} /></Route></Route></Route>
