...
import ProgressiveRegister from "./pages/MarketplaceRegister";
import { About, Contact, HowItWorks } from "./pages/PublicPages";
import Membership from "./pages/MarketplaceMembership";
import SafetyPage from "./pages/SafetyPage";
import Home from "./pages/MarketplaceHome";
import NotFound from "./pages/NotFound";
import Discover from "./pages/MarketplaceDiscover";
...
export default function App() {
  return <div className="min-h-screen bg-cream text-charcoal"><Seo /><Routes>
    ...
    <Route element={<AuthLayout />}><Route path="/register" element={<ProgressiveRegister />} /><Route path="/join" element={<Navigate to="/register" replace />} /><Route path="/onboarding" element={<ProgressiveRegister />} /><Route path="/login" element={<Login />} /><Route path="/verify-email" element={<VerifyEmail />} /><Route path="/email-verification-required" element={<VerificationRequired />} /><Route path="/forgot-password" element={<ForgotPassword />} /><Route path="/reset-password" element={<ResetPassword />} /></Route>
    ...
    <Route element={<ProtectedRoute />}><Route element={<MemberLayout />}><Route element={<SettingsLayout />}><Route path="/settings" element={<Navigate to="/settings/preferences" replace />} /><Route path="/settings/account" element={<AccountSettings />} /><Route path="/settings/preferences" element={<ProfilePage />} /><Route path="/settings/privacy" element={<PrivacySettings />} /><Route path="/settings/notifications" element={<Notifications />} /><Route path="/settings/security" element={<SecuritySettings />} /><Route path="/settings/membership" element={<MembershipSettings />} /></Route><Route path="/notifications" element={<Notifications />} /><Route path="/account" element={<Navigate to="/app/discover" replace />} /><Route path="/profile" element={<Navigate to="/app/profile" replace />} /><Route path="/app" element={<Navigate to="/app/discover" replace />} /><Route path="/app/profile" element={<ProfilePage />} /><Route path="/app/notifications" element={<Notifications />} /></Route></Route>
