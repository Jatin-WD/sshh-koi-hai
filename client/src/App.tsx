...
export default function App() {
  return <div className="min-h-screen bg-cream text-charcoal"><Seo /><Routes>
    ...
    <Route element={<ProtectedRoute />}><Route element={<SubscriptionGuard />}><Route path="/app/discover" element={<Discover />} /><Route path="/app/likes" element={<Likes />} /><Route path="/app/matches" element={<Matches />} /><Route path="/app/messages" element={<Messages />} /><Route path="/app/messages/:conversationId" element={<Messages />} /></Route></Route>
