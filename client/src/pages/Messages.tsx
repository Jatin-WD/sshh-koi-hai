...
export default function Messages() {
  ...
  useEffect(() => {
    ...
    const socket = io(socketUrl, { transports: ["websocket"], withCredentials: true, reconnection: true, reconnectionAttempts: 3, reconnectionDelay: 2000, reconnectionDelayMax: 10000, timeout: 5000 }); socketRef.current = socket;
