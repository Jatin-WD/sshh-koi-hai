      ...
      <form key={formVersion} onSubmit={save} className="space-y-6">
        <div className="rounded-3xl border border-charcoal/10 bg-white/80 p-7 shadow-soft">
          ...
          <div className="mt-6 grid gap-5 sm:grid-cols-2">
            ...
            <label className="text-sm">Gender<select name="gender" defaultValue={profile.gender} className={inputClass}><option value="MAN">Man</option><option value="WOMAN">Woman</option><option value="NON_BINARY">Non-binary</option><option value="OTHER">Prefer to self-describe</option></select></label>
            <label className="text-sm">Marital status<select name="maritalStatus" defaultValue={profile.maritalStatus ?? "SINGLE"} className={inputClass}><option value="SINGLE">Single</option><option value="DIVORCED">Divorced</option><option value="WIDOWED">Widowed</option><option value="SEPARATED">Separated</option></select></label>
        ...
        <div className="rounded-3xl border border-charcoal/10 bg-white/80 p-7 shadow-soft">
          ...
          <div className="mt-6 grid gap-5 sm:grid-cols-2">
            ...
            <label className="text-sm">Interested in<select name="genderPreference" defaultValue={profile.genderPreference ?? ""} className={inputClass}><option value="">Any gender</option><option value="MAN">Men</option><option value="WOMAN">Women</option><option value="NON_BINARY">Non-binary people</option><option value="OTHER">Self-described people</option></select></label>
