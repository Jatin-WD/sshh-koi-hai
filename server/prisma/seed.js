...
function dob(yearsAgo, month, day) {
    return new Date(Date.UTC(new Date().getUTCFullYear() - yearsAgo, month - 1, day));
}
const demoUsers = [
    { key: "aanya", email: "aanya.demo@example.test", displayName: "Aanya Mehta", gender: "FEMALE", city: "Mumbai", maritalStatus: "SINGLE", lookingFor: "DATING", age: 28, interests: ["Cinema", "Travel", "Cooking"], bio: "Slow mornings, good films, and conversations with a little depth.", occupation: "Architect", education: "Design", languages: ["English", "Hindi"], relationshipIntent: "A thoughtful connection", onlineStatus: true },
    { key: "kabir", email: "kabir.demo@example.test", displayName: "Kabir Rao", gender: "MALE", city: "Delhi", maritalStatus: "SINGLE", lookingFor: "RELATIONSHIP", age: 31, interests: ["Jazz", "Books", "Running"], bio: "Collecting records, city walks, and stories worth staying up for.", occupation: "Product designer", education: "Communication", languages: ["English", "Hindi"], relationshipIntent: "A genuine relationship", onlineStatus: false },
    { key: "meera", email: "meera.demo@example.test", displayName: "Meera Iyer", gender: "FEMALE", city: "Bengaluru", maritalStatus: "DIVORCED", lookingFor: "CHAT", age: 36, interests: ["Gardening", "Art", "Podcasts"], bio: "Curious by nature, happiest near plants and an unhurried conversation.", occupation: "Editor", education: "Literature", languages: ["English", "Tamil"], relationshipIntent: "Companionship and conversation", onlineStatus: false },
    { key: "rohan", email: "rohan.demo@example.test", displayName: "Rohan Sen", gender: "MALE", city: "Pune", maritalStatus: "MARRIED", lookingFor: "FRIENDSHIP", age: 42, interests: ["Cycling", "History"], bio: "Weekend cyclist and lifelong learner. Here for kind conversation.", occupation: "Teacher", education: "History", languages: ["English", "Marathi"], relationshipIntent: "New friendships", onlineStatus: true },
    { key: "tara", email: "tara.demo@example.test", displayName: "Tara Kapoor", gender: "NON_BINARY", city: "Hyderabad", maritalStatus: "SINGLE", lookingFor: "DATING", age: 24, interests: ["Photography", "Theatre", "Coffee"], bio: "Finding beauty in ordinary places and people who notice the details.", occupation: "Photographer", education: "Fine arts", languages: ["English", "Telugu"], relationshipIntent: "Something intentional", onlineStatus: true },
    { key: "dev", email: "dev.demo@example.test", displayName: "Dev Malhotra", gender: "MALE", city: "Jaipur", maritalStatus: "PREFER_NOT_TO_SAY", lookingFor: "CHAT", age: 22, interests: ["Gaming"], bio: null, occupation: null, education: null, languages: [], relationshipIntent: null, onlineStatus: false },
];
...
async function main() {
    ...
    if (!adminEmail || !adminPassword)
        throw new Error("ADMIN_EMAIL and ADMIN_INITIAL_PASSWORD are required to run the seed");
    ...
    const aanya = users.get("aanya");
    const kabir = users.get("kabir");
    const meera = users.get("meera");
    const tara = users.get("tara");
