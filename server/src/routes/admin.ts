...
const settingDefaults = { membershipMode: "EVERYONE_PAID", minimumAge: 18, maxProfileImages: 6, siteName: "Sshh... Koi Hai?", supportEmail: "hello@sshhkoihai.com", profileCompletionRequirement: 60 };
